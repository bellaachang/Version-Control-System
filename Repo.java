...
public class Repo {
    ...
    public void checkout(String[] args) {
        ...
        if (args[1].equals("--")) {
            ...
            Commit actualCommitLolSoCool = Utils.readObject(
                    desiredCommit, Commit.class);
            if (!actualCommitLolSoCool.getFileTracker().containsKey(fileName)) {
                System.out.println("File does not exist in that commit.");
                System.exit(0);
            }
            String blobName = actualCommitLolSoCool.
    ...
    /** Checkout branch case because my thingy too long.
     * @param args args;
     * @return
     * */
    ...
    /** For the stupid method length thing.
